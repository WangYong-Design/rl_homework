...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, batch_size):
        """
        Collect itr training trajectories

        Input:
        - itr: Number of needed training trajectories
        - initial_expertdata: None
        - collect_policy: The executed policy when collect trajectories
        ...
        print("\nBegin collect Trainging trajectories...")
    ...
    def train_agent(self):
        # observations,actions,unconcatenated_rews,next_observations,terminals = self.agent.sample(self.params["batch_size"])
